...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("hyprpaper & waybar & hypridle & hyprsunsent")
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(393D4780)", "rgba(393D4780)" }, angle = 45 },
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("flatpak run app.zen_browser.zen"))
